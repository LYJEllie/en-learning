...
| 模式 | 面向 | 题量 | 内容 |
|---|---|---|---|
| 🧒 小学生入门 | 刚学英语的小学生 | 24 题 | 打招呼 / 课堂 / 生活 / 交朋友 |
...
实测：小学生模式 24 题能抽出 **864 种不同组合**（4 类选 3 × 每类 6 题 = 864）；跑 200 局 600 题，正解落在 A/B/C 的次数是 209 / 192 / 199，判定零错误。
...
| 大类 | key | id | 考什么 |
|---|---|---|---|
| 👋 打招呼篇 | `hello` | `kh-` | Good morning / Nice to meet you / See you tomorrow / How are you / What's your name / Have a nice day → You too |
| 🏫 课堂篇 | `class` | `kc-` | 点名答"到" Here! / May I …, please? / I don't understand / 听懂 page ten / 迟到 May I come in? / 短答 Yes, I do. |
| 🏠 生活篇 | `life` | `kl-` | What color…? 回什么 / Would you like…? / 被夸怎么回 / fine 与 nine / Help yourself! / Bless you! |
| 🎈 交朋友篇 | `friend` | `kf-` | Can I play with you? / Sorry 与 Excuse me / Here you are 三句链 / Are you OK? / Would you like some? / Your turn! |
...
<script>
  ...
  ★ 第二段 题库       BANK_KIDS（24 题）· BANK_ADULT（4 题） ← 扩充题目只改这里
...
|---|---|---|---|
| 24 题（现在，每类 6） | 78 KB | 864 | 玩十几局才会撞见重复题 |
| 40 题（每类 10） | ~100 KB | 4 000 | 舒适区，单文件还很好翻 |
...
- **每类 6 题**（现在这样）已经够小朋友玩很多次不腻
- **每类 10 题**是甜点，40 题左右，单文件仍然好维护
- 超过 60 题就按最后一节拆成 `data/*.js`，别硬扛在一个文件里
